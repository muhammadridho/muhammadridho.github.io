...
window.onload = function(){
    ...
    console.log(localStorage.HAIpassword);
...
var dataRegistrasi =  {
    ...
    validasiNama : false,
    posisiSekarang : '',
    dataNotes : [['Persiapan Presentasi','Jelaskan setidaknya tiga alasan kenapa audiens harus belajar mendesain slide presentasi, bisa','Presentasi'],['Persiapan Berkemah','tes kemudian lagi','Makan'],['Cek kemudian','tes lagi','Ngegym']],
    PertamaPost : true,
    Teman : ['tony','ridho'],
...
function detectionList(){
    //console.log(this.children[0].className == 'icon-nav teman' ? openFriends() : 'tidak');
...
function openNotes(){
    ...
    selectoption.onchange = function(input){console.log(selectoption.value)};
...
function cobaHapus(){
    ...
    console.log(nomorIndex);
    dataRegistrasi.dataNotes.splice(nomorIndex,1);
    console.log(dataRegistrasi.dataNotes);
...
function validasiAmbilData(){
    ...
    for (var index = 0; index < dataRegistrasi.dataNotes.length; index++){
        if (notesYangDiambil == dataRegistrasi.dataNotes[index][0]){
            sudahAda = true;
            console.log("Nomor ke" +index);
        }
    }
    if (sudahAda === false){
       // mengirimNotes("ada");
       //for (var index = 0 ;index < dataRegistrasi.dataNotes.length;index++){
           //console.log(dataRegistrasi.dataNotes[index][0]);
           //console.log(dataRegistrasi.dataNotes[index][0] === notesYangDiambil ? dataRegistrasi.dataNotes[index][0]+">"+notesYangDiambil : false);
